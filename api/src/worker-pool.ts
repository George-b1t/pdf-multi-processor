...
export class Pool {
  ...
  private createWorker(): void {
    const pathName = __dirname.includes('dist')
      ? path.resolve(__dirname, '../src/pdf-worker.js')
      : path.resolve(__dirname, '../dist/src/pdf-worker.js');

    const workerPath = path.resolve(pathName);
